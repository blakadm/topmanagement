    ...
    <?php
                                            echo Highcharts::widget([
                                                ...
                                                'options' => [
                                                    ...
                                                    'title' => [
                                                        'useHTML'=>true,
                                                         'text' => '<div style="text-align:center;">' . $currentType .' distribution per Month for '. '<br/><div class="changeColorTitle">' . $initialRegion . ' for ' . $selectedYear . $monthCount . '</div></div>',
