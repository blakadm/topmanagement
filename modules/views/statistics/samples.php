...
function InitiateIteration() {
    ShowProgress(true);
    IsHide = !IsHide;
    series = highChart_Samples.series;
    ...
    <div class="col-lg-10">
        <div class="col-lg-8 box box-primary" style="height: 500px">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box-body">
                ...
                Yii::$app->PostedData->GenerateChart("Samples",$Request->ChartType, "Samples", $Request->ChartTitle, "/toplevel/statistics/samples", $Request->Categories, $Request->Series,850,400,"sand-signika","0.f");
                ?>
            </div>
        </div>
    </div>  
