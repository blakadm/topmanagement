    ...
    <div class="col-md-12">
        ...
        <div class="tab" role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="">
                   <div style="margin-left: 0px;margin-right: 10px;margin-bottom: 10px;margin-top: 10px;width:300px">
                            <?php
                                            echo Select2::widget([
                                                'name' => 'dropIndicator',
                                                'id' => 'dropIndicator',
...
//alert($('#status_13').is(\":checked\"));
            ...
            <div id="divAllSamples">
                    <?php Pjax::begin(); ?>
             <?php
                  echo $this->render('_subyear', ['listYear'=>$listYear,'listRstl'=>$listRstl,'listlab'=>$listlab,'dataTables'=>$dataTables,
                  'dataColumn'=>$dataColumn,'dataPieGraph'=>$dataPieGraph,
                  'dataBar'=> $dataBar,'listMonths'=>$listMonths,'initialRegion'=>$initialRegion,'curYearValue'=> $curYearValue,'selectedYear'=>$selectedYear,'currentType'=>$currentType,'pTurn'=>$pTurn,'monthCount'=>$monthCount]);
              ?>
                          <?php Pjax::end(); ?>
            </div>
    </div>
