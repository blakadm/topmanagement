...
<div class="tab-content tabs">
               ...
               <div class="row">
                          <div class="col-md-3" style="margin-left: 0px;margin-bottom: 10px;margin-top: 0px">
                                   <?php
                                    echo Select2::widget([
                                        'name' => 'dropIndicator',
                                        'id' => 'dropIndicator',
                    ...
                    <div id="divColumnPieOverall">   
                     <?php Pjax::begin(); ?>
                                    <?php
                                      echo $this->render('_subcolumnpieoverall',[ 'dataColumnOverall'=>$dataColumnOverall,'dataPieOverall'=>$dataPieOverall,'listDost'=>$listDost,'listIndicator'=>$listIndicator
                                              ,'dataPieOverall'=>$dataPieOverall,'curType'=>$curType,'curYear'=>$curYear,'curIndicator'=>$curIndicator,'pTurn'=>$pTurn,'dataLineArray'=>$dataLineArray
