...
<div class="row">
    ...
    <div class="col-md-6" style="text-align: center">
        <a href="/toplevel/statistics/accomplishmentrdi" style="color:#3c8dbc">
            <div class="item" style=" float: none; margin: 0 auto;width: 80%;height: 180px;background-color: #f7f7f7">
                <br>
                ...
                <div style="margin-left: 20px;">
                    ...
                    <span>
                        <img class src="/images/icons/samples.png" style="float: left;
                             ...
                             ">
                        <div style="float: left;"><h4>RDI's Accomplishment</h4></div>
    ...
    <div class="col-md-6" style="text-align: center">
        <a href="/toplevel/statistics/accomplishmentperrstl" style="color:#3c8dbc">
            <div class="item" style=" float: none; margin: 0 auto;width:  80%;height: 180px;background-color: #f7f7f7">
                <br>
                ...
                <div style="margin-left: 20px;">
                    ...
                    <span>
                        <img class src="/images/icons/samples.png" style="float: left;
                             ...
                             vertical-align: middle;
                             ">
                        <div style="float: left;"><h4>Individual Accomplishment</h4></div>
                        <div style="clear: left"> <p>Individual Accomplishment per RSTL/RDI.</p></div>
                ...
                <div style="margin-left: 20px;">
                    ...
                    <span>
                        <img class src="/images/icons/samples.png" style="float: left;
                             ...
                             vertical-align: middle;
                             ">
                        <div style="float: left;"><h4>Ranking ( RDI )</h4></div>
            ...
            <div class="item" style=" float: none; margin: 0 auto;width:  80%;height: 180px;background-color: #f7f7f7">
                ...
                <div  style="margin-left: 20px;">
                    ...
                    <span>
                        ...
                        <div style="clear: left"> <p>Summary of overall accomplishments and targets for RSTL's and RDI's.</p></div>
