 ...
 * @property \mdm\admin\models\User $createdBy
 * @property \mdm\admin\models\User $modifiedBy
...
class Items extends Articles
{
    ...
    public function rules()
    {
        return array_merge(AccessTrait::rules(), CreatedTrait::rules(), ImageTrait::rules(), LanguageTrait::rules(), ModifiedTrait::rules(), SeoTrait::rules(), StateTrait::rules(), TitleAliasTrait::rules(), UserTrait::rules(), VideoTrait::rules(), [
            [['title', 'user_id', 'created', 'modified','state','access','theme','hits', 'language'], 'required'],
            [['cat_id', 'ordering','user_id','created_by','modified_by', 'hits'], 'integer'],
    ...
    public function getImageUrl() 
    {
        ...
        return Yii::$app->request->hostInfo.$file;
    }
