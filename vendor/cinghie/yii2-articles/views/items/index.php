...
$this->params['breadcrumbs'][] = ['label' => Yii::t('articles', 'Articles'), 'url' => ['/articles/']];
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'visible'=> Yii::$app->user->can('articles-publish-his-items') || Yii::$app->user->can('articles-publish-all-items')
                    ],
                    [
                        'attribute' => 'id',
                        'width' => '5%',
